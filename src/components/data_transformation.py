...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            # Pipeline for department (OneHotEncoder)
            ...
            # Pipeline for salary (OrdinalEncoder)
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            # Reshape input_feature_train_arr if it's a single row
            if input_feature_train_arr.shape[0] == 1 and target_feature_train_df.shape[0] > 1:
               input_feature_train_arr = input_feature_train_arr.reshape(-1, input_feature_train_arr.shape[-1])
            
            if input_feature_test_arr.shape[0] == 1 and target_feature_test_df.shape[0] > 1:
               input_feature_test_arr = input_feature_test_arr.reshape(-1, input_feature_test_arr.shape[-1])
